      ...
      <form onSubmit={onSubmit} className="mt-5 space-y-5">
        <div className="space-y-2">
          ...
          <input
            ...
            autoComplete="email"
            inputMode="email"
            className="w-full appearance-none rounded-2xl border border-gray-300 bg-white px-4 py-3.5 text-gray-900 shadow-sm outline-none placeholder:text-gray-500 focus:border-gray-400 focus:ring-2 focus:ring-green-200"
            value={email}
